...
// import shellLogo from "@/assets/shell.jpeg";
// import kantarLogo from "@/assets/kantar.jpeg";
// import cbaLogo from "@/assets/CBA.jpeg";
...
//     period: "September 2025 – Present",
//     color: "from-yellow-500/20 to-red-500/20",
//     // We'll use 'cover' for Shell and CBA to fill the block
//     logoStyle: "object-cover",
//     description: "Managed IT assets across the organization, provided end-user support...",
//     points: [/* ... same points ... */],
//   },
//   {
//     role: "IT Support Analyst (Level-3)",
...
//     period: "December 2022 – August 2025",
//     color: "from-blue-500/20 to-cyan-500/20",
//     // We use 'contain' for Kantar so the word "KANTAR" isn't cut off
//     logoStyle: "object-contain p-1", 
//     description: "Streamlined networking activities by operating virtual servers...",
//     points: [/* ... same points ... */],
//   },
//   {
//     role: "Sr. Customer Care Representative",
...
//     color: "from-purple-500/20 to-pink-500/20",
//     logoStyle: "object-cover",
//     description: "Delivers proactive support to 60-70 customers on daily basis...",
//     points: [/* ... same points ... */],
//   },
//   {
//     role: "Agile Software Tester",
...
//     period: "August 2021 – October 2021",
//     color: "from-green-500/20 to-emerald-500/20",
//     description: "Formulated test scenarios and cases...",
//     points: [/* ... same points ... */],
//   },
// ];
...
//         <div className="grid lg:grid-cols-[280px_1fr] gap-8">
//           {/* Sidebar Tabs */}
//           <motion.div className="flex lg:flex-col gap-3 overflow-x-auto lg:overflow-visible pb-2 lg:pb-0">
//             {experiences.map((exp, i) => (
//               <button key={exp.company} onClick={() => setActiveExp(i)}
//                 className={`flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all duration-300 shrink-0 ${
//                   activeExp === i ? "glass-card border-primary/40 shadow-lg" : "hover:bg-secondary/30"
//                 }`}>
//                 <div className="w-10 h-10 rounded-lg bg-white flex items-center justify-center shrink-0 overflow-hidden border border-white/10">
//                   {exp.logo ? (
//                     <img 
//                         src={exp.logo} 
//                         alt="" 
//                         className={`w-full h-full ${exp.logoStyle || "object-cover"}`} 
//                     />
//                   ) : (
...
//           <div className="relative min-h-[500px]">
//             <AnimatePresence mode="wait">
//               <motion.div key={activeExp} initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="glass-card p-8">
//                 <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
//                   <div className="flex items-center gap-4">
//                     {experiences[activeExp].logo && (
//                       <div className="w-14 h-14 bg-white rounded-xl shrink-0 overflow-hidden border border-white/10 shadow-sm">
//                         <img 
//                             src={experiences[activeExp].logo} 
//                             alt="" 
//                             className={`w-full h-full ${experiences[activeExp].logoStyle || "object-cover"}`} 
//                         />
//                       </div>
//                     )}
//                     <div>
...
//                     </div>
//                   </div>
//                   <span className="px-4 py-1.5 rounded-full text-xs font-medium border border-primary/30 text-primary bg-primary/5 h-fit">
//                     {experiences[activeExp].period}
//                   </span>
//                 </div>
//                 {/* ... Rest of the points and description ... */}
//                 <p className="text-muted-foreground text-sm mb-6 leading-relaxed">{experiences[activeExp].description}</p>
//                 <ul className="space-y-3">
//                   {experiences[activeExp].points.map((point, idx) => (
...
// // Import local assets from your specific path
// import shellLogo from "@/assets/shell.jpeg";
// import kantarLogo from "@/assets/kantar.jpeg";
// import cbaLogo from "@/assets/CBA.jpeg";
...
//     period: "September 2025 – Present",
//     color: "from-yellow-500/20 to-red-500/20",
//     fillMode: "object-cover", // Fills the block entirely
//     description:
//       "Managed IT assets across the organization, provided end-user support for applications, mobile connectivity issues and hardware-related issues, and ensured smooth operation of meeting room AV systems.",
//     points: [
//       "Supported and troubleshot network connectivity issues, ensuring stable and secure access for users.",
...
//     period: "December 2022 – August 2025",
//     color: "from-blue-500/20 to-cyan-500/20",
//     fillMode: "object-contain p-1.5", // Exception for Kantar to keep text visible
//     description:
//       "Streamlined networking activities by operating virtual servers and checking the network connections in the server room. Providing 2nd/3rd Level Technical support.",
//     points: [
//       "Efficiently resolved technical issues and provided support to end-users, ensuring minimal downtime SLAs and maximum productivity.",
...
//                 {/* Logo Box - Solid background, filled with logo */}
//                 <div className="w-10 h-10 rounded-lg bg-white flex items-center justify-center shrink-0 overflow-hidden border border-white/10">
//                   {exp.logo ? (
//                     <img 
//                       src={exp.logo} 
//                       alt="" 
//                       className={`w-full h-full ${exp.fillMode || "object-cover"}`}
//                     />
//                   ) : (
//                     <div className={`w-full h-full rounded-lg bg-gradient-to-br ${exp.color} flex items-center justify-center`}>
//                        <Building2 size={18} className={activeExp === i ? "text-primary" : "text-muted-foreground"} />
//                     </div>
//                   )}
//                 </div>
...
//                           src={experiences[activeExp].logo} 
//                           alt="" 
//                           className={`w-full h-full ${experiences[activeExp].fillMode || "object-cover"}`}
//                         />
//                       </div>
//                     )}
//                     <div>
...
//                     </div>
//                   </div>
//                   <span className="px-4 py-1.5 rounded-full text-xs font-medium border border-primary/30 text-primary bg-primary/5 shrink-0 h-fit">
//                     {experiences[activeExp].period}
//                   </span>
//                 </div>
...
const experiences = [
  ...
  },
  {
    ...
    points: [
      ...
      "Handle complex customer enquiries, complaints, and escalations efficiently.",
      "Build and maintain strong relationships to enhance customer satisfaction and loyalty.",
      "Provide tailored banking solutions aligned with customer needs.",
      "Investigate and resolve disputes related to accounts, transactions, fraud, or lending.",
      "Contribute to team performance targets and service level agreements (SLAs).",
      "Consistently meet KPIs including CSAT, Net Promoter Score (NPS), call handling time, and resolution targets.",
    ],
  },
  {
    role: "Agile Software Tester",
